...
-- 
INSERT INTO gifts (gift, giver, price, previously_regifted, true) VALUES ('peach candle', 'Santa', 9, true);
...
('vanilla candle', 'Hannah', 6, false),
('train', 'Bobby', 22, false),
('cards', 'Peter', 11, false),
('backpack', 'Tori', 15, true),
('bowl', 'Mary', 10, true);
...
--
SELECT * FROM gifts WHERE giver = 'Santa' OR > 30;
